...
advanced_and_or_queries = [
    "SELECT [column] FROM {table} WHERE [condition1 AND condition2 AND condition3]",
    "SELECT [column] FROM {table} WHERE [condition1] OR [condition2] OR [condition3]",
    "SELECT [column] FROM {table} WHERE [condition1] OR [condition2] OR [condition3] ORDER BY [column]",
    "SELECT [column] FROM {table} WHERE [condition1 AND condition2] OR [condition3]",
    "SELECT [column] FROM {table} WHERE [condition1 AND condition2] OR [condition3 AND column4]",
    "SELECT [column] FROM {table} WHERE [condition1 OR condition2] AND [condition3 OR column4]",
]
...
group_by_queries = [
    ...
    "SELECT [column1], [aggregation]([column2]) FROM {table} WHERE [condition1 AND condition2 AND condition3] GROUP BY [column1]",
    "SELECT [column1], [aggregation]([column2]) FROM {table} WHERE [condition1 AND condition2 AND condition3] GROUP BY [column1] ORDER BY [column1] LIMIT [n]"
]
